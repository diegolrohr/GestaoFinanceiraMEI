...
namespace Fly01.Compras.Controllers
{
    public class GrupoProdutoController : BaseController<GrupoProdutoVM>
    {
        ...
        public override ContentResult Form()
        {
            ...
            config.Elements.Add(new InputCustommaskUI { Id =  "aliquotaIpi", Class = "col s6 l3", Label = "Alíquota Ipi",
                Data = new { inputmask = "'mask': '9{1,3}[,9{1,2}] %', 'alias': 'decimal', 'autoUnmask': true, 'suffix': ' %', 'radixPoint': ',' " }
            });

            config.Elements.Add(new SelectUI { Id = "tipoProduto", Class = "col s6 l3", Label = "Tipo Produto", Required = true,
