...
namespace Fly01.Core.Presentation.Commons
{
    public static class ImportHelper
    {
        ...
        public static IEnumerable<PropertyInfo> GetDisplayEntityColumns(string entity, bool onlyWithJsonProperty = true)
        {
            ...
            return entityType.GetProperties().Where(x => (onlyWithJsonProperty ? System.Attribute.IsDefined(x, typeof(DisplayAttribute)) : true) &&
                                                         System.Attribute.IsDefined(x, typeof(JsonPropertyAttribute)));
        }
