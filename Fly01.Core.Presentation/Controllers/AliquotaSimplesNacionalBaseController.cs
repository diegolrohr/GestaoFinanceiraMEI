...
namespace Fly01.Core.Presentation.Controllers
{
    ...
    public class AliquotaSimplesNacionalBaseController<T> : BaseController<T> where T : AliquotaSimplesNacionalVM
    {
        ...
        public ContentResult FormModal(Guid idParametro = default(Guid))
        {
            ModalUIForm config = new ModalUIForm()
            {
                ...
                ConfirmAction = new ModalUIAction() { Label = (idParametro != default(Guid) ? "Aplicar" : "Salvar") },
            ...
            config.Elements.Add(new AutoCompleteUI
            {
                ...
                DomEvents = new List<DomEventUI>
                {
                    new DomEventUI() { DomEvent = "autocompleteselect", Function = "fnSelectTipoEnquadramentoEmpresa" }
                }
            });
