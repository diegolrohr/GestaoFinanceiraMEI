...
using Fly01.Financeiro.Models.SSO;
...
namespace Fly01.Financeiro.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            var tokenData = RestHelper.ExecuteGetAuthToken(AppDefaults.UrlGateway.Replace("v2/financeiro/", "v2/"), AppDefaults.GatewayUserName, AppDefaults.GatewayPassword, platformUrl, platformUser);
