    ...
    public class ContaReceberController : ContaFinanceiraController<ContaReceberVM, ContaFinanceiraBaixaVM, ContaFinanceiraRenegociacaoVM>
    {
        ...
        public ContentResult ListContaReceber(string gridLoad = "GridLoad")
        {
            ...
            config.Actions.AddRange(GetActionsInGrid(new List<DataTableUIAction>()
            {
                ...
                new DataTableUIAction { OnClickFn = "fnModalImprimeBoleto", Label = "Imprimir boleto", ShowIf = "row.statusEnum != 'Pago' && row.formaPagamento_descricao == 'Boleto'" },
                new DataTableUIAction { OnClickFn = "fnEditImprimeBoleto", Label = "Imprimir boleto", ShowIf = "row.statusEnum != 'Pago' && row.formaPagamento_descricao != 'Boleto'" }
            }));
