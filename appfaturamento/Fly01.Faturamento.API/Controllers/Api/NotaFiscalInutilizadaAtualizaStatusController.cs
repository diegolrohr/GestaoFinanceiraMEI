...
{
    [RoutePrefix("notafiscalinutilizadaatualizaStatus")]
    public class NotaFiscalInutilizadaAtualizaStatusController : ApiBaseController
    {
        public virtual async Task<IHttpActionResult> Get()
        {
            try
            {
                using (UnitOfWork unitOfWork = new UnitOfWork(ContextInitialize))
                {
                    ...
                    unitOfWork.MonitorNFBL.AtualizaStatusTSSInutilizada(PlataformaUrl);
