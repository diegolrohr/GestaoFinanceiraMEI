...
namespace Fly01.Faturamento.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            var tokenData = RestHelper.ExecuteGetAuthToken(AppDefaults.UrlGateway.Replace("v2/faturamento/", "v2/"), AppDefaults.GatewayUserName, AppDefaults.GatewayPassword, platformUrl, platformUser);
