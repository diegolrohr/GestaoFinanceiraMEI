...
namespace Fly01.Compras.Controllers
{
    public class OrcamentoController : BaseController<OrcamentoVM>
	{
		...
		public ContentResult FormOrcamento(bool isEdit = false)
		{
			...
			config.Elements.Add(new ButtonUI { Id =  "btnAddOrcamentoItem", Class = "col s12 m2", Value = "Adicionar produto",
		...
		public ContentResult Visualizar()
		{
			...
			config.Elements.Add(new AutocompleteUI { Id = "formaPagamentoId", Class = "col s12 m6", Label = "Forma Pagamento", Disabled = true,
				DataUrl = Url.Action("FormaPagamento", "AutoComplete"),
				LabelId = "formaPagamentoDescricao"
			});
			config.Elements.Add(new AutocompleteUI { Id = "condicaoParcelamentoId", Class = "col s12 m6", Label = "Condição Parcelamento", Disabled = true,
				DataUrl = Url.Action("CondicaoParcelamento", "AutoComplete"),
				LabelId = "condicaoParcelamentoDescricao"
			});
			config.Elements.Add(new AutocompleteUI { Id = "categoriaId", Class = "col s12", Label = "Categoria", Disabled = true,
				DataUrl = @Url.Action("Categoria", "AutoComplete"),
				LabelId = "categoriaDescricao",
			});
			...
			config.Elements.Add(new TableUI { Id =  "orcamentoItensDataTable", Class = "col s12", Disabled = true,
