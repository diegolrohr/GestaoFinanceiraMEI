...
namespace Fly01.EmissaoNFE.Domain.Entities.NFe.ICMS
{
    ...
    public class ICMSSN202 : ICMS
    {
        ...
        public ICMSSN202(OrigemMercadoria origemMercadoria, TipoTributacaoICMS codigoSituacaoOperacao, TipoCRT tipoCRT) : base(origemMercadoria, codigoSituacaoOperacao, tipoCRT)
        {
        }
