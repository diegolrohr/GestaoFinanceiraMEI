namespace Fly01.EmissaoNFE.DAL.Migrations
{
    ...
    public partial class Create_Icms : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.Icms", "EstadoOrigemId", "dbo.Estado");
            DropForeignKey("dbo.Icms", "EstadoDestinoId", "dbo.Estado");
            DropIndex("dbo.Icms", new[] { "EstadoDestinoId" });
            DropIndex("dbo.Icms", new[] { "EstadoOrigemId" });
            DropTable("dbo.Icms");
        }
    }
}
