...
using Fly01.Estoque.Models.SSO;
...
namespace Fly01.Estoque.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            var tokenData = RestHelper.ExecuteGetAuthToken(AppDefaults.UrlGateway.Replace("v2/estoque/", "v2/"), AppDefaults.GatewayUserName, AppDefaults.GatewayPassword, platformUrl, platformUser);
