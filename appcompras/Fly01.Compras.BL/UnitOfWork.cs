...
namespace Fly01.Compras.BL
{
    public class UnitOfWork : UnitOfWorkBase
    {
        ...
        public PedidoBL PedidoBL => pedidoBL ?? (pedidoBL = new PedidoBL(Context, PedidoItemBL, OrdemCompraBL, NFeEntradaBL, NFeProdutoEntradaBL, NotaFiscalItemTributacaoEntradaBL));
