...
namespace Fly01.Financeiro.DAL.Migrations.DataInitializer
{
    ...
    {
        private List<Estado> listOfStates;

        public EstadoDataInitializer()
        {
            listOfStates = new List<Estado>()
                {
        ...
        public void Initialize(AppDataContext context)
        {
            ...
            {
                var id = Guid.Parse("DD4D2CA7-A30A-4660-88D3-9D132916832E");//adicionado depois que já estava em prod
        ...
        public List<Estado> GetLstOfStates()
        {
            return listOfStates;
        }
    }
