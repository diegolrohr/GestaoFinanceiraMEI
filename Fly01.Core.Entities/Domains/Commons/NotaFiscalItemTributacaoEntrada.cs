...
{
    public class NotaFiscalItemTributacaoEntrada : PlataformaBase
    {
        [Required]
        public Guid NotaFiscalItemEntradaId { get; set; }
        ...
        public virtual NotaFiscalItemEntrada NotaFiscalItemEntrada { get; set; }
    }
}