...
namespace Fly01.Compras.BL
{
    public class NFeProdutoEntradaBL : PlataformaBaseBL<NFeProdutoEntrada>
    {
        ...
        public override void ValidaModel(NFeProdutoEntrada entity)
        {
            ...
            var jaExiste = All.Any(x => x.NotaFiscalEntradaId == entity.NotaFiscalEntradaId && x.ProdutoId == entity.ProdutoId && x.GrupoTributarioId == entity.GrupoTributarioId && x.Id != entity.Id);
